...
class ScanNetEval(object):
    ...
    def evaluate_matches(self, matches):
        ...
        # results: class x iou
        ap = np.zeros((len(dist_threshes), len(self.eval_class_labels), len(ious)), np.float64)
        rc = np.zeros((len(dist_threshes), len(self.eval_class_labels), len(ious)), np.float64)
    ...
    def print_results(self, avgs):
        ...
        with open('ap_ar.txt', 'a') as file:
            for (li, label_name) in enumerate(self.eval_class_labels):
                ...
                line += sep + '{:>8.4f}'.format(ap_avg) + sep
                line += sep + '{:>8.4f}'.format(ap_50o) + sep
                line += sep + '{:>8.4f}'.format(ap_25o) + sep
                line += sep + '{:>8.4f}'.format(rc_avg) + sep
                line += sep + '{:>8.4f}'.format(rc_50o) + sep
                line += sep + '{:>8.4f}'.format(rc_25o) + sep
                print(line)
                # 将数据写入文件
                file.write(line + '\n')  
        with open('ap_ar.txt', 'a') as file:
            ...
            line += '{:>8.4f}'.format(all_ap_avg) + sep
            line += '{:>8.4f}'.format(all_ap_50o) + sep
            line += '{:>8.4f}'.format(all_ap_25o) + sep
            line += '{:>8.4f}'.format(all_rc_avg) + sep
            line += '{:>8.4f}'.format(all_rc_50o) + sep
            line += '{:>8.4f}'.format(all_rc_25o) + sep
            print(line)
            print('#' * lineLen)
            print()
            file.write(line + '\n')
